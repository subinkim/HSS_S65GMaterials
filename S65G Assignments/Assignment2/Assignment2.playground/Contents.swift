 ...
 */
//var zipped = zip( [Int](repeating: 0, count: 10) , 0 ..< 10 )
//type(of: zipped)
/*
 // ** Zip2Sequence<Array<Int>,Range<Int>>  **
 */
/*:
 4. In `positions`, what is the type of the value returned from the first call to map?
 */
//var pos = (0 ..< 10).map{ zip ([Int] (repeating: $0, count: 10), 0 ..< 10)}
//type(of: pos)
/*
 // ** Array<Zip2Sequence<Array<Int>, Range<Int>>> **
 */
/*:
 5. what is the type of the value returned from the call to flatMap?
 */
//var flatPos = pos.flatMap{$0}
//type(of:flatPos)
/*
 // ** Array<(Int, Int)> **
 */
...
/*
 The coordinates of the cells surrounding the given cell, which are to be used for making calculations and decision if the cell will be alive or not in the next iteration.
 */
/*:
 ## Problem 6:
...
/*
 'of' is the name that you use to specify a parameter when you call the function externally, for example,
 neighbors(of: ~~~~)
 */
/*:
...
/*
 'cell' is the name that you use inside the function, in the place of a variable.
 */
...
extension Grid {
    ...
    func neighbors(of cell: Cell) -> [Position] {
        ...
        return Grid.offsets.map {
            ...
            return Position(row: norm($0.row + cell.position.row, to: self.rows), col: norm($0.col + cell.position.col, to: self.cols))
        }
    }
}
/*:
...
/*
Position, as defined by a typealias
 */
/*:
...
/*
 takes in <Int, Int> and returns <Int>
 */
/*:
 ## Problem 12:
...
/*
 the grid has 100 cells (10 rows, 10 columns) and a third of 100 cells is about 33 cells.
 */
/*:
 ## Problem 14:
...
/*
 subscript returns Cell? - it can also return nil
 */
/*:
...
/*
 if self[$1.row, $1.col] value is invalid
 */
/*:
 ## Problem 16:
...
/*
 it counts the number of living cells among the neighbour cells of the given cell
 */
...
/*
 position of the given cell / current cell
 */
...
extension Grid {
    func nextState(of cell: Cell) -> CellState {
        ...
        case 3,
             2 where cell.state.isAlive : return .alive
...
/*
 it represents the next state of the grid after going through one iteration based on the rules of Conway's Game of Life
 */
/*:
 ## Problem 22:
