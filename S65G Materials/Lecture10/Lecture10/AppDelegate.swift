...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        if let defaults = defaults.object(forKey: "simulationConfiguration") as? Data,
            ...
            print(recovered)
            //use the techniques shown in class to parse the recovered data using a JSONDecoder
            // you may then access (UIApplication.shared.delegate as? AppDelegate).configuration
            // anywhere in the app
        } else {
